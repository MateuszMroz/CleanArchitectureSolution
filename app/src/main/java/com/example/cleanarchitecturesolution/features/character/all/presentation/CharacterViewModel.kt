...
import com.example.cleanarchitecturesolution.features.character.all.presentation.model.CharacterUiState
...
class CharacterViewModel(
    ...
    fun onCharacterClick(characterId: Int) {
        characterNavigator.openCharacterDetailsScreen(characterId)
    }
